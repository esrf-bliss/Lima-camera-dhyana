...
{   
    ...
    TUIDP_ENDPROPERTY           = 0x14,             // id property end 
}TUCAM_IDPROP;
...
typedef enum 
{
    ...
    TUREG_BAD_ROW               = 0x03,             // The type register bad row 
    TUREG_BAD_COL               = 0x04,             // The type register bad column 
    TUREG_BGC                   = 0x05,             // The type register background
 }TUREG_TYPE;
